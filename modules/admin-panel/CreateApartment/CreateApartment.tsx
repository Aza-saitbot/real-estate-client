...
import MediaAddField from "@/modules/admin-panel/CreateApartment/Gallery/MediaAddField/MediaAddField";
...
const CreateApartment = ({editApartment, employees, categories}: CreateEditApartmentProps) => {
    ...
    return (
        <div className={s.wrapper}>
                ...
                <form onSubmit={methods.handleSubmit(onHandlerSave)}>
                    <div className={s.createApartment}>
                        <div className={s.header}>
                            <div>
                                <h3> {editApartment ? editApartment.title : 'Добавить недвижимость'}</h3>
                            </div>
                            <div>
                                <Button onClick={activeOpenModal}>Добавить поле</Button>
                            </div>
            ...
            <ModalStyled open={openModal} onChangeStateOpen={activeOpenModal}>
                <MediaAddField handlerCloseModal={handlerCloseModal}/>
            </ModalStyled>
        </div>
    )
};
